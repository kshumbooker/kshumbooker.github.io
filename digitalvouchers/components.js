...
const digitalVouchers = [
  ...
  },
  {
    ...
    midascode: 584723,
    promotion: 'Percentage off',
    description: 'Both Trolleys Get 10% off when purchasing any product in the Booker',
    expiry: 10,
    expired: false,
    url: '',
    clickAndCollect: true,
  ...
  },
  {
    ...
    midascode: 584724,
    promotion: 'Money off',
    description: 'Both Trolleys Get 10% off when purchasing any product in the Lidl',
    expiry: 10,
    expired: false,
    url: '',
    clickAndCollect: true,
