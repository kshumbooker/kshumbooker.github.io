  ...
  data: [
    {
      ...
      caseQuantity: 12,
      caseWeight: '500ml',
      product: 'C4 Energy Cosmic Rainbow PM159',
      description: 'PRESELL ONLY: MAKE 62.3% POR',
      wsp: 5.99,
      rrp: 1.59,
      por: 62.3,
      vat: 20,
    ...
    },
    {
      ...
      caseQuantity: 12,
      caseWeight: '500ml',
      product: 'C4 Energy Frozen Bombsicle PM159',
      description: 'PRESELL ONLY: MAKE 62.3% POR',
      wsp: 5.99,
      rrp: 1.59,
      por: 62.3,
    ...
    },
    {
      ...
      caseQuantity: 12,
      caseWeight: '12s',
      product: 'Calpol Fast Melt 6+ Clipstrip',
      description: 'PRESELL ONLY: WIGIG - SAVE £13.00 ON STD WSP',
      wsp: 19.99,
      rrp: 3.99,
      por: 49.9,
      vat: 20,
    ...
    },
    {
      ...
      caseQuantity: 2,
      caseWeight: '10 x 440ml',
      product: 'Carlsberg Export',
      description: 'PRESELL ONLY: MAKE 30.3% POR',
      wsp: 16.49,
      rrp: 14.19,
      por: 30.3,
      vat: 20,
...
if (document.getElementById('agreeTsAndCsCheck')) {
  const newPresellHtmlDesktop = document.querySelectorAll('.desktop-view');

  const newPresellHtmlMobile = document.querySelectorAll('.mobile-view'); 

  newPresellHtmlDesktop[1].innerHTML = `
      ...
      <div class="col-8 product-quantities">
        <div class="d-flex row">
          <div class="product-quantity-date-header flex-fill">
            <p class="mb-0">Drop 1</p>
            <p class="mb-0">w/c 10th November</p>
          </div>
          <div class="product-quantity-date-header flex-fill">
            <p class="mb-0">Drop 2</p>
            <p class="mb-0">w/c 17th November</p>
          </div>
          <div class="product-quantity-date-header flex-fill">
            <p class="mb-0">Drop 3</p>
            <p class="mb-0">w/c 24th November</p>
          </div>
          <div class="product-quantity-date-header flex-fill">
            <p class="mb-0">Drop 4</p>
            <p class="mb-0">w/c 1st December</p>
          </div>
          <div class="product-quantity-date-header flex-fill">
            <p class="mb-0">Drop 5</p>
            <p class="mb-0">w/c 8th December</p>
          </div>
          <div class="product-quantity-date-header flex-fill">
    ...
    ${presellData.data.map(presell => `<div class="d-flex row product">
    <div class="col-4 product-details">
        <div class="d-flex row">
            ...
            <div class="col-10">
                <div class="d-flex p-4">
                    ...
                    <div class="prices-and-taxes ml-auto">
                        <div class="d-flex justify-content-end price">
                            <div class="col-6">
                                <span class="font-weight-bold">WSP:</span>
                            </div>
                            <div class="col-6">
                                <span class="">&#163;${presell.wsp}</span>
                            </div>
                        </div>
    ...
    <div class="col-8 product-quantities">
      <div class="d-flex product-quantities-row">
        ${presell.drops.map(drop => drop.active ? ` <div class="d-flex flex-fill justify-content-center product-quantity-date align-items-center text-center flex-row-reverse presell-mode">
          ...
          <input data-drop=${drop.drop} data-headerid=${headerId} data-productid=${presell.mCode} data-val="true" data-val-number="The field SeletedByClient must be a number." data-val-required="The SeletedByClient field is required." id="" name="SeletedByClient" type="number" value=${drop.quantity} />
          <div class="plus-minus-icon mr-1" data-updatemode="minus">
            <i class="fas fa-minus"></i>
              ...
              <input type="number" value=${drop.quantity} disabled="" />
                ...
                <div class="col-4 totals-texts">
                    <p class="color-blue bigger font-weight-bold text-right">Drop Totals:</p>
                </div>
                <div class="col-8 totals-values">
                    <div class="d-flex totals-values-row row">
            ...
            <div class="d-flex row totals">
                <div class="col-4 totals-texts">
                    <p class="font-weight-bold color-blue bigger text-right">Drop Total Guide Price (ex VAT):</p>
                </div>
                <div class="col-8 totals-values">
                    <div class="d-flex totals-values-row row">
                            <div class="flex-fill d-flex justify-content-center totals-value">
            ...
            <div class="d-flex row totals">
                <div class="col-4 totals-texts">
                    <p class="color-blue bigger font-weight-bold text-right">Drop Total Guide Price (inc VAT):</p>
                </div>
                <div class="col-8 totals-values">
                    <div class="d-flex totals-values-row row">
                            <div class="flex-fill d-flex justify-content-center totals-value">
            ...
            <div class="d-flex row totals">
                <div class="col-7 totals-texts">
                </div>
                <div class="col-5 totals-values">
                    <div class="d-flex totals-values-row row">
                        <div class="col-10 d-flex justify-content-end totals-value bigger">
                            <p class="color-blue font-weight-bold bigger text-right">Total Guide Price (ex VAT):</p>
                        </div>
                        <div class="col-2 d-flex justify-content-center totals-value bigger">
                            <p class="color-blue font-weight-bold">£0.00</p>
                        </div>
                    </div>
                </div>
            </div>
            <div class="d-flex row totals">
                ...
                <div class="col-5 totals-values">
                    <div class="d-flex totals-values-row row">
                        <div class="col-10 d-flex justify-content-end totals-value">
                            <p class="color-blue font-weight-bold text-right bigger">Total Guide Price (inc VAT):</p>
                        </div>
                        <div class="col-2 d-flex justify-content-center totals-value">
                            <p class="color-blue font-weight-bold bigger">£0.00</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="card-header" id="checkout-delivered-heading-${presell.index}" data-toggle="collapse"
            ...
            <div class="d-flex row product">
                <div class="col-12 product-details pl-0 pr-0">
                    <div class="d-flex row">
                        <div class="codProd-col col-2 d-flex justify-content-center product-number flex-column align-items-center pr-0 pl-0">
                            <span class="codPro"><i class="fas fa-chevron-down"></i>M${presell.mCode}</span>
                            
                        </div>

                        <div class="productImageCol col-2 d-flex justify-content-center flex-column pb-2 pt-2 pr-0 pl-0">
                            <div class="product-image-chevron flex-row align-items-center hidden">
                                <i class="fas fa-chevron-down"></i>
                                <img class="product-image-mobile" src=${presell.img} alt=${presell.product} />
                            </div>
                            
                            <p class="case-weight-mobile mb-0 hidden">${presell.caseQuantity} x ${presell.caseWeight}</p>
                        </div>
                        <div class="caseImageCol col-2 d-flex justify-content-center pb-2 pt-2 pr-0 pl-0">
                            <div class="case-image">
                                <span class="case-quantity font-weight-bold">Case of ${presell.caseQuantity}</span>
                                <p class="case-weight mb-0">${presell.caseWeight}</p>
                            </div>
                        </div>
                        <div class="textProCol col-4 d-flex pb-2 pt-2 pr-0 pl-0">
                            <div class="align-self-center flex-column">
                                <div class="product-name-priceMarked">
                                    <p class="product-name font-weight-bold mb-0">${presell.product}</p>
                                </div>
                                <span class="discount font-weight-bold">${presell.description}</span>
                            </div>
                        </div>
                        <div class="prices-and-taxes-col col-2 d-flex justify-content-center pb-2 pt-2 pr-0 pl-0">
                            <div class="prices-and-taxes">
                                <div class="d-flex justify-content-end  price">
  ...
  const disablePreSellElements = (checked) => {
    const updateTotals = document.querySelectorAll('#presell_button .update-total');
    ...
    if (!checked) {
      ...
      [...updateTotals].map(total => total.classList.add('disabled'));
      ...
      [...updateTotals].map(total => total.classList.toggle('disabled'));
    }
  }
